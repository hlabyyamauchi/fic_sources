...
void outputconv1(float *conv1){
	...
	write_params("/home/asap2/yyamauchi/lenettest/params/conv1out_bd0.txt", tmp[0], C1_OCH*C1_ICH*C1_OSIZE*CONV1_LOOPEXE);	
	write_params("/home/asap2/yyamauchi/lenettest/params/conv1out_bd1.txt", tmp[1], C1_OCH*C1_ICH*C1_OSIZE*CONV1_LOOPEXE);	
	write_params("/home/asap2/yyamauchi/lenettest/params/conv1out_bd2.txt", tmp[2], C1_OCH*C1_ICH*C1_OSIZE*CONV1_LOOPEXE);	
	write_params("/home/asap2/yyamauchi/lenettest/params/conv1out_bd3.txt", tmp[3], C1_OCH*C1_ICH*C1_OSIZE*CONV1_LOOPEXE);	
	return;
}
void main() {
	int i, j, k, l;
